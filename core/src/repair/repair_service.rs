...
use {
    ...
    solana_ledger::{
        ...
        blockstore_meta::{BlockLocation, RepairSlotMeta},
        shred,
    },
...
impl RepairEligibility {
    ...
    fn observe_slot(&mut self, slot: Slot, slot_meta: &RepairSlotMeta) {
    ...
    pub fn generate_repairs_in_range(
        ...
        for slot in repair_range.start..=repair_range.end {
            ...
            let meta = blockstore
                ...
                .unwrap_or(RepairSlotMeta {
                    slot,
                    ..RepairSlotMeta::default()
                });
